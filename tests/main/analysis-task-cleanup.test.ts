...
import { WorkspaceRepository, type AnalysisTaskRecord } from '../../src/main/data/workspace-repository';
...
function saveTask(repository: WorkspaceRepository, id: string, status: AnalysisTaskRecord['status']): void {
